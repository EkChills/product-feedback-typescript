       ...
       <div className=" bg-[#F7F8FD] min-h-[100vh] w-full">
        ...
        <div className="px-[1.5rem] flex-col space-y-[1rem]">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="font-[.8125rem] font-[400] text-[#647196]">Ideas prioritized for research</p>
          </div>
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="font-[.8125rem] font-[400] text-[#647196]">Features currently being developed</p>
          </div>
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="font-[.8125rem] font-[400] text-[#647196]">Released features</p>
          </div>
